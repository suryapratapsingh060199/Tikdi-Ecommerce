    ...
    return (
        <div className='MyAddresses'>
            ...
            <label for="javascript">
                <p className='user_add_details'>Name: Hrishi</p>
                <p className='user_add_details'>Address: SMVDU, Katra, J&K</p>
                <p className='user_add_details'>Mobile: 8000947822</p>
                <p  className='user_add_details'>Email: hrishidadhich@gmail.com</p>
            </label>
            </div>
            </div>
            {
